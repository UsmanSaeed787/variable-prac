...
var a1 = "Eric";
console.log("Hello " + a1 + " Would you like to learn type script today");
// QUESTION 3
// Name Cases: Store a person’s name in a variable, and then print that person’s 
// name in lowercase, uppercase, and titlecase.
var person_name = "Usman Saeed";
...
const quote1 = "When You Succeed Be Humble";
const quote2 = "Imam Ali [as]";
console.log(quote1 + ":", quote2);
//Question 5
const quote3 = quote2;
console.log(quote1 + ":", quote3);
// Question 6
...
// program does.
/*HELLO MY NAME IS USMAN SAEED, TODAY DATE IS 09/06/023, I AM STUDENT OF PIAIC AND LEARNING TYPE SCRIPT*/
